...
![image-20220824155307256](./images/image-20220824155307256.avif)
...
<div class="foot" v-if="item.status === OrderType.ConsultChat">
  <van-button v-if="item.prescriptionId" class="gray" plain size="small" round>查看处方</van-button>
  <van-button type="primary" plain size="small" round :to="`/room?orderId=${item.id}`">继续沟通</van-button>
</div>
...
![image-20220824155407302](./images/image-20220824155407302.avif)
...
```html
<div class="consult-detail-page" v-if="item">// ...</div>
...
<cp-consult-more
  ...
  @on-preview="onShowPrescription(item.prescriptionId)"></cp-consult-more>
````

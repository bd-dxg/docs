...
![image-20220813195713860](./images/image-20220813195713860.avif)
...
```html
<router-link to="/consult/fast" @click="store.setType(ConsultType.Fast)" class="nav"></router-link>
```

## 极速问诊-选择极速问诊类型{#consult-change-type}

![image-20220815133500165](./images/image-20220815133500165.avif)
...
```html
<router-link to="/consult/dep" class="item" @click="store.setIllnessType(1)"></router-link>
```

```html
<router-link to="/consult/dep" class="item" @click="store.setIllnessType(0)"></router-link>
```

## 极速问诊-选择科室-布局{#consult-dep-html}

![image-20220824154050319](./images/image-20220824154050319.avif)
...
![image-20220824154141532](./images/image-20220824154141532.avif)
...
![image-20220824154246436](./images/image-20220824154246436.avif)
...
![image-20220824154323546](./images/image-20220824154323546.avif)
...
![image-20220920225526881](./images/image-20220920225526881.avif)
...
```html
<van-action-sheet v-model:show="show" title="选择支付方式" :close-on-popstate="false"></van-action-sheet>
```
...
<van-action-sheet
  ...
  :closeable="false"></van-action-sheet>
```
...
![image-20220824154549604](./images/image-20220824154549604.avif)

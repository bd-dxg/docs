...
![image-20220902131335118](./images/image-20220902131335118.avif)
...
<script
  ...
  data-redirecturi="http://consult-patients.itheima.net/login/callback"></script>
```
...
![image-20220901163913209](./images/image-20220901163913209.avif)
...
![image-20220901163349489](./images/image-20220901163349489.avif)
...
<van-form autocomplete="off" @submit="bind" ref="form">
  <van-field v-model="mobile" name="mobile" :rules="mobileRules" placeholder="请输入手机号"></van-field>
...
<body>
  ...
  <script
    src="https://connect.qq.com/qc_jssdk.js"
    data-appid="102015968"
    data-redirecturi="<%=VITE_APP_CALLBACK%>/login/callback"></script>
</body>
```
...
![image-20220905110845886](./images/image-20220905110845886.avif)

2）关联码云，需要码云授权

![image-20220905111106986](./images/image-20220905111106986.avif)

3）选择需要使用的仓库

![image-20220905111526726](./images/image-20220905111526726.avif)

4）构建配置

![image-20220905111847289](./images/image-20220905111847289.avif)

![image-20220905111952307](./images/image-20220905111952307.avif)

5）进行构建

![image-20220905112105818](./images/image-20220905112105818.avif)

![image-20220905112731150](./images/image-20220905112731150.avif)

6）尝试访问

![image-20220905112907762](./images/image-20220905112907762.avif)

自动部署流程：

![image-20220905113553768](./images/image-20220905113553768.avif)

## 部署-gitlab部署(演示)

![image-20220905124702905](./images/image-20220905124702905.avif)
...
![生成store](./images/generate-store.webm)

#### view

![生成view](./images/generate-view.webm)

#### component

![生成component](./images/generate-component.webm)

...
![image-20220811163550162](./images/image-20220811163550162.avif)
...
```html
<van-swipe>
  <van-swipe-item v-for="item in 5" :key="item">{{ item }}</van-swipe-item>
</van-swipe>
```
...
```html
<van-swipe :width="150" :show-indicators="false" :loop="false"></van-swipe>
```
...
```html
<van-swipe :width="(150 / 375) * width" :show-indicators="false" :loop="false"></van-swipe>
```

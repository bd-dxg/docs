...
![image-20220816220114053](./images/image-20220920225526881.avif)

## 药品订单-支付页面

![image-20220830174600932](./images/image-20220830174600932.avif)
...
<template>
  <div class="order-pay-page" v-if="orderPre && address">
    ...
    <van-submit-bar
      ...
      button-text="立即支付"
      button-type="primary"
      text-align="left"></van-submit-bar>
  </div>
...
![image-20220830174508558](./images/image-20220830174508558.avif)
...
![image-20220830185418506](./images/image-20220830185418506.avif)
...
![image-20220831105232116](./images/image-20220831105232116.avif)

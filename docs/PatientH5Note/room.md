...
![image-20220829154759024](./images/image-20220829154759024.avif)
...
<template>
  <div class="evaluate-card">
    ...
    <van-rate :modelValue="3" size="7vw" gutter="3vw" color="#FADB14" void-icon="star" void-color="rgba(0,0,0,0.04)" />
  </div>
  <div class="evaluate-card">
